...
RUN git clone https://github.com/msafdarkhan/merapuppet.git /app/merapuppet && cd /merapuppet \
...
ENV PYTHONPATH="/app/merapuppet:/app/merapuppet/fomm"
